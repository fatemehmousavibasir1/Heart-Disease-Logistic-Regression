...
X=h_data[['ST depression induced by exercise relative to rest','number of major vessels colored by fluoroscopy','male','reversible defect','asymptomatic','normal','flat']]
